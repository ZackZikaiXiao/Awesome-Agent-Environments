...
- [AssistantBench](https://aclanthology.org/2024.emnlp-main.505/). EMNLP 2024. Web-assisted benchmark for complex, realistic assistant tasks.
...
- [Hybrid-Gym](https://arxiv.org/abs/2602.16819). ArXiv 2026. Coding-agent training environment aimed at cross-task generalization. [![GitHub Repo stars](https://img.shields.io/github/stars/yiqingxyq/Hybrid-Gym)](https://github.com/yiqingxyq/Hybrid-Gym)
...
- [SWE-smith](https://openreview.net/forum?id=63iVrXc8cC). NeurIPS 2025. Pipeline that turns any Python repository into a SWE-gym, generating 50K task instances from 128 GitHub repos for agent training.
